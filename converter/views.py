            ...
            try:
                if form.is_valid():
                    ...
                    if re.match(".*.xml", name):
                        ...
                        return render(request, 'rnaml.html',
                                      {'dot': dot, 'path_dot': path_dot, 'ct': ct, 'path_ct': path_ct, 'bpseq': bpseq,
                                       'path_bpseq': path_bpseq})
                    #################################KONWERSJA Z DOT_BRACKET#######################
                        ...
                        return render(request, 'dot.html',
                                      {'rnaml': rnaml, 'path_rnaml': path_rnaml, 'ct': ct, 'path_ct': path_ct,
                                       'bpseq': bpseq, 'path_bpseq': path_bpseq})
                    else:
                        ...
                        if re.findall(connect, str(file_lines)):
                            ...
                            return render(request, 'ct.html',
                                          {'dot': dot, 'path_dot': path_dot, 'rnaml': rnaml, 'path_rnaml': path_rnaml,
                                           'bpseq': bpseq, 'path_bpseq': path_bpseq})
                        #################################KONWERSJA Z BPSEQ#############################
                            ...
                            # wizual = wizualizacja(rodzaj,file_name)
                            return render(request, 'bpseq.html',
                                          {'dot': dot, 'path_dot': path_dot, 'rnaml': rnaml, 'path_rnaml': path_rnaml,
                                           'ct': ct, 'path_ct': path_ct})
                        else:
